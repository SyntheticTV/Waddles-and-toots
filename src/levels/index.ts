...
import { twoPinesMall } from './twoPinesMall';
 ...
 */
export const LEVELS: LevelSpec[] = [backyardBbq, fineRestaurant, schoolHallway, sunriseYoga, sunsetBeach, cornerGrocery, departures, twoPinesMall];
